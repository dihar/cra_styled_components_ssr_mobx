...
export default (req, res) => {
  /*
    A simple helper function to prepare the HTML markup. This loads:
      - Page title
      - SEO meta tags
      - Preloaded state (for Mobx) depending on the current route
  ...
  */
  ...
  fs.readFile(
    ...
    (err, htmlData) => {
      ...
      // Styled components server render
      ...
      /*
        Here's the core funtionality of this file. We do the following in specific order (inside-out):
          ...
          3. Inside of a React <StaticRouter /> (since we're on the server), given a location and context to write to
      ...
      */
      frontloadServerRender(() =>
        ...
        if (context.url) {
          // If context has a url property, then we need to handle a redirection in React Router
          res.writeHead(302, {
